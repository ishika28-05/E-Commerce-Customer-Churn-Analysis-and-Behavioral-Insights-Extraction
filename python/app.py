...
with col2:
    ...
    payment_mode = st.selectbox("Preferred Payment Mode",["Debit Card", "Credit Card", "UPI","E wallet","Cash on Delivery"])
with col3:
    gender = st.selectbox("Gender" ,[ "Female","Male"])
    order_category = st.selectbox("Prefered Order Cat",["Fashion","Grocery","Laptop & Accessory","Mobile Phone","Others"])
